...
date: 2024-12-02 12:39:30
tags: AI FPGA
categories: AI-Acceleration
thumbnail: assets/img/hls4ml_logo.png
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            loading="eager" 
            path="assets/img/hls4ml_logo.png" 
            class="img-fluid rounded z-depth-1" 
            zoomable=true 
        %}
    </div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            loading="eager" 
            path="assets/img/ksy1542323312067.image" 
            class="img-fluid rounded z-depth-1" 
            zoomable=true 
        %}
    </div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            loading="eager" 
            path="assets/img/UART_Transmitter.png" 
            class="img-fluid rounded z-depth-1" 
            zoomable=true 
        %}
    </div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            loading="eager" 
            path="assets/img/UART_Receiver.png" 
            class="img-fluid rounded z-depth-1" 
            zoomable=true 
        %}
    </div>
